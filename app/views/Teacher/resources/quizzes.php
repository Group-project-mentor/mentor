            ...
            <section class="mid-content">
                ...
                <div class="container-box">
                    <div class="rc-resource-header">
                        <h1>QUIZZES</h1>
                        <a href="<?php echo BASEURL?>TQuiz/create">
                    ...
                    <section class="quiz-card-list" id="quiz-card-list">
                        ...
                        <div class="quiz-card-main">
                            ...
                            <div class="quiz-card-button-set">
                                ...
                                <a class="quiz-card-btn" href="<?php echo BASEURL.'TQuiz/questions/'.$row->id ?>">
                                    <img src='<?php echo BASEURL."assets/icons/icon_edit.png" ?>' alt=''>
                                </a>
                                
                                <a class="quiz-card-btn" href="<?php echo BASEURL.'TQuizPreview/instructions/'.$row->id ?>">
