...
<!--                </a>-->
        ...
        <section class="mid-content">
            ...
            <div class="mid-title">
                ...
                <h6>My Subjects / <?php echo ucfirst($_SESSION['cid']) ?>/quizzes</h6>
            </div>
            ...
            <div class="container-box">
                <div class="rc-resource-header">
                    ...
                    <div class="rc-quiz-top-btns">
                        <a href="<?php echo BASEURL . "TQuiz/editQuiz/" . $data[1][0] ?>">
                            <div class="rc-add-btn">
                                Edit Quiz
                            </div>
                        </a>
                        <a href="<?php echo BASEURL.'TquizPreview/instructions/'.$data[4] ?>">
                            <div class="rc-add-btn">
                                Preview
                            </div>
                        </a>
                        <a href="<?php echo BASEURL . "TQuiz/addQuestion/" . $data[1][0] ?>">
                            <div class="rc-add-btn">
                                + Add Question
                            </div>
                        </a>
                ...
                <div class="rc-resource-table">
                    ...
                    <div class="rc-pdf-row">
                        ...
                        <div class="rc-quiz-row-btns">
                            ...
                            <a href="<?php echo BASEURL . 'TQuiz/addAnswers/' . $data[4] . '/' . $row['number'] ?>">
