        ...
        <div class="content-area">
            ...
            <section class="mid-content">
                ...
                <div class="mid-title">
                    ...
                    <h6>My Subjects / <?php echo ucfirst($_SESSION['cid']) ?> / video / add </h6>
                </div>
                ...
                <div class="rc-upload-box">
                    <form action="<?php echo BASEURL . 'TAdd/addVideo' ?>" enctype="multipart/form-data" method="POST" class="rc-upload-form" id="upload-form">
