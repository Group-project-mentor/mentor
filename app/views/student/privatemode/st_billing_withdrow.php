      ...
      <section class="mid-content">
        ...
        <style>
          * {
          ...
          #date {
            background: url(assets/icons/calender.png) no-repeat 95%;
          }

          #cardholder {
            background: url(assets/icons/holder.png) no-repeat 95%;
          }

          #cardnumber {
            background: url(assets/icons/creditcard.png) no-repeat 95%;
          }

          #verification {
            background: url(assets/icons/lock.png) no-repeat 95%;
          }
