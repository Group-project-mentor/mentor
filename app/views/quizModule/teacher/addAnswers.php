        ...
        <section class="mid-content">
            ...
            <div class="container-box">
                ...
                <div  class="quiz-container" >
                    ...
                    <a style="display: flex;justify-content: center;text-decoration: none;" href="<?php echo BASEURL.'TQuiz/answer/'.$data[0].'/'.$data[1] ?>">
                    ...
                    <div id="quiz-box">
                        ...
                        <div class="quiz-box-answer">
                            ...
                            <a class="quiz-box-edit" href="<?php echo BASEURL.'TQuiz/editAnswer/'.$data[0].'/'.$data[1].'/'.$row[0]?>">
