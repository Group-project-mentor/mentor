    ...
    <section class="page">
        ...
        <div class="content-area">
            ...
            <section class="mid-content">
                ...
                <div class="mid-title">
                    <h6>My Subjects / <?php echo ucfirst($_SESSION['cid']) ?> / others / <?php echo $data->id ?></h6>
                </div>

                <!-- Grade choosing interface -->
                <div class="container-box" >
                    <embed src="<?php echo BASEURL?>private_resources/others/<?php echo $_SESSION['cid']."/".$data->location ?>" style="width:50%;height:70vh;margin:auto;">
                </div>
                <?php } ?>
            </section>
        </div>
