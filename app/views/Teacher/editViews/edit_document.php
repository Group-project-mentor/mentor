        ...
        <div class="content-area">
            ...
            <section class="mid-content">
                ...
                <div class="mid-title">
                    ...
                    <h6>My Subjects / <?php echo ucfirst($_SESSION['cid']) ?> / document / edit </h6>
                </div>
                ...
                <div class="rc-upload-box">
                    <form action="<?php echo BASEURL.'TEdit/editDocument/'.$data[0][0] ?>" method="POST" enctype="multipart/form-data" class="rc-upload-form">
