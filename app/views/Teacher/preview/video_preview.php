            ...
            <section class="mid-content" style="margin: 10px 0 10px;">
                ...
                <div class="container-box" style="margin-top: 10px;">
                    ...
                    <div class="subject-card-watching">
                        <?php if ($data[1][6] === "L") { ?>
                            <iframe style="width: 720px;height:480px;" src="<?php echo $data[1][4] ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
                            </iframe>
