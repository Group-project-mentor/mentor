                    ...
                    if (!empty($data[0])) { ?>
                        <div class="rc-resource-table" id="rc-resource-table">
                            <div class="rc-table-title">
                                <div class="rc-resource-col" styel="flex-start;">Report Name</div>
                            </div>
                            <?php
                            foreach ($data[0] as $row) { ?>
                                <div class='rc-pdf-row'>
                                    ...
                                    <div class='rc-quiz-row-btns'>
                                        ...
                                        <a href='<?php echo BASEURL ?>TReport/edit/<?php echo $row->id ?>'>
                                            <img src='<?php echo BASEURL ?>assets/icons/icon_edit.png' alt=''>
                                        </a>


                                        <a href='<?php echo BASEURL ?>TReport/preview/<?php echo $row->id ?>'>
                        ...
                        <div class="pagination-set">
                            ...
                            <div class="pagination-set-right">
                                <?php if ($data[1][0] != 1) { ?>
                                    <a href="<?php echo BASEURL . "TReport/studentReports/" . $_SESSION['cid'] . "/" . ($data[1][0]) - 1 ?>">
                                        < </a>
                                        <?php } ?>
                                        ...
                                        <?php if ($data[1][0] < $data[1][1]) { ?>
                                            <a href="<?php echo BASEURL . "TReport/studentReports/" . $_SESSION['cid'] . "/" . ($data[1][0] + 1) ?>"> > </a>
                                        <?php } ?>
                            </div>
                        </div>
                </div>
...
<script>
    ...
    function renderDocumentData(data, USER) {
        ...
        rendered += ` <button onclick='delConfirm(${data.id},4)' >
                                                    ...
                                                    <a href='${BASEURL}TReport/editReport/${data.id}'>
                                                        <img src='${BASEURL}assets/icons/icon_edit.png' alt=''>
                                                    </a>`

        rendered += `<a href='${data.id}TReport/preview//${data.id}'>
