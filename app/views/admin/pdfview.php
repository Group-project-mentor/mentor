...
<?php require_once("C:/xampp/htdocs/mentor/public/components/alerts/admin/resources_add.php"); ?>
    ...
    <section class="ad_mid-content">
        ...
        <div class="content">
            ...
            <div class="name">
                <p>' . $data['pdfv'][0]['name'] . '</p>
            </div>
            
            <div id="com-title">
                <p>' . $data['pdfv'][0]['description'] . '</p>
            </div>
            <div class="btns">
                <button class="comp-btns" onclick="approve(\''.$data['pdfv'][0]['id'].'\')" type="button">Approve</button>
                <button class="comp-btns" onclick="decline(\''. $data['pdfv'][0]['id'].'\')" type="button">Decline</button>
            </div>
