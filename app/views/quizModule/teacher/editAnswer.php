    ...
    <div class="content-area">
        ...
        <section class="top-bar">
            ...
            <div class="top-bar-btns">
                <a href="<?php echo BASEURL . 'TQuiz/addAnswers/' . $data[0] . '/' . $data[2] ?>">
        ...
        <section class="mid-content">
            ...
            <div class="container-box">
                ...
                <div  style="margin-top:30px;" class="quiz-answer-main quiz-ans-popup" id="ansBox">
                    <form class="quiz-answer-set" action="<?php echo BASEURL . 'TQuiz/editAnswerAction/' . $data[0] . '/' . $data[2] . '/' . $data[1][0] ?>" method="POST">
