            ...
            <section class="mid-content">
                ...
                <div class="pagination-set" id="pagination-set">
                    ...
                    <div class="pagination-set-right">
                        <?php if ($data[1][0] != 1) {?>
                            <a href="<?php echo BASEURL . "rcResources/pastpapers/".$_SESSION['gid']."/".$_SESSION['sid']."/". ($data[1][0] - 1)."/".($data[1][2]) ?>"> < </a>
                        <?php }?>
...
<script>
    ...
    filterButton.onclick = (e) =>  {
        ...
        let url = `${BASEURL}rcResources/pastpapers/${grade}/${subject}/${PAGE}/?`;
