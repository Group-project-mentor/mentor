    ...
    <div class="content-area">
        ...
        <section class="mid-content">
            ...
            <div class="mid-title">
                ...
                <h6>My Subjects / <?php echo ucfirst($_SESSION['cid']) ?> / video / edit </h6>
<!--                --><?php //echo $_SESSION['message'] ?>
            ...
            <div class="rc-upload-box">
                <form action="<?php echo BASEURL.'TEdit/editVideoUploaded/'.$data[0][0] ?>" enctype="multipart/form-data" method="POST" class="rc-upload-form" id="upload-form">
