            ...
            <section class="mid-content">
                ...
                <div class="container-box">
                    ...
                    <!-- <div class="subject-card-set">
                            ...
                            <label>Grade 8</label>
                            <a href="<?php echo BASEURL  ?>" class="Enter-btn">Enroll</a>
                        </div>
                        <div class="subject-card">
                    ...
                    <?php if(!empty($data)){?>
                        <div class="subject-card-set">
                            ...
                            <div class="subject-card">
                                ...
                                <label>Grade 8</label>
                                <a href="<?php echo BASEURL."subject_to_enroll/enroll_records/3/".$row['id']?>" class="Enter-btn" style="background-color: #0A2917 ; color:white ; border : 3px">Enroll</a>
                            </div>
                            <?php } ?>
                        </div>
