            ...
            <section class="mid-content">
                ...
                <div class="container-box">
                    <div class="subject-card-set">
                        ...
                        <div class="subject-card">
                            <img src="assets/patterns/2.png" alt="" />
                            <a href="#"><label>C79 - Science</label></a>
                            <label>Grade 6</label>
                        </div>
                        <div class="subject-card">
                            <img src="assets/patterns/3.png" alt="" />
                            <a href="#"><label>C79 - Science</label></a>
                            <label>Grade 6</label>
                        </div>
                        <div class="subject-card">
                        ...
                        <div class="subject-card">
                            <img src="assets/patterns/4.png" alt="" />
                            <a href="#"><label>C79 - Science</label></a>
                            <label>Grade 6</label>
                        </div>
                        <div class="subject-card">
                            <img src="assets/patterns/5.png" alt="" />
                            <a href="#"><label>C79 - Science</label></a>
                            <label>Grade 6</label>
                        </div>
                        <div class="subject-card">
                            <img src="assets/patterns/6.png" alt="" />
                            <a href="#"><label>C79 - Science</label></a>
                            <label>Grade 6</label>
                        </div>
                        <div class="subject-card">
