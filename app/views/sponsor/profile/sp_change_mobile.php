    ...
    <section class="page">
        ...
        <div class="content-area">
            ...
            <section class="mid-content">
                ...
                <form class="rc-profile rc-profile-change-name" method="POST" action="<?php echo BASEURL ?>sponsor/changeMobile">
                    <div class="rc-text-inp-grp">
                        <label for="password" class="lbl-input">Mobile no: </label><br>
                        <input  type="text"
                                class="txt-input"
                                placeholder="New Mobile Number"
                                value="<?php echo (!empty($data[0]->mobileNo)) ? $data[0]->mobileNo: "" ?>"
                                name="mobile"
                                pattern="[0-9]{10}"
