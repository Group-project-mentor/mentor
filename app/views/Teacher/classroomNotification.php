...
<head>
    ...
    <title>Teacher class message</title>
    ...
    <div class="message-area">
        <div class="message">
            ...
            <div class="message-image">
                <img src="public/assets/Teacher/clips/msg 1.png" alt="error image">
            </div>
            ...
            <section class="mid-content">
                ...
                <div class="class section">
                    <form>
                      ...
                      <input type="text" id="class_name" name="class name" placeholder="New class name..">
