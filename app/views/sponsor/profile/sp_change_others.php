    ...
    <section class="page">
        ...
        <div class="content-area">
            ...
            <section class="mid-content">
                ...
                <div class="mid-title">
                    <h1>Profile - Change Details</h1>
                    <h6><?php echo $_SESSION['name'] ?></h6>
                </div>

                <form class="rc-profile rc-profile-change-name" method="POST" action="<?php echo BASEURL ?>sponsor/changeOther">
                    <div class="rc-text-inp-grp">
                        <label for="name" class="lbl-input">Description : </label><br>
                        <textarea
                                cols = "50"
                                rows="10"
                                placeholder="New Description"
                                name="desc" ><?php echo $data[0]->description ?></textarea>
                    </div>
                    <button type="submit" class="rc-add-btn">Save</button>
                </form>
            </section>
