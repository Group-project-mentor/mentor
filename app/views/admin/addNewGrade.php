            ...
            <form class="form">
                ...
                <div class="dataentry">
                    <form class="gradeadd">
                        ...
                        <div class="addgradename">
                            <input type="Name" name="grade-name" id="grade-name" placeholder="   Enter Grade Name" class="inputfield"><br>
                        </div>
                ...
                <div class="btns">
                    <button class="comp-btns" type="button">Add </button>
                </div>
