...
<div class="message-area">
    <div class="message message-back-warn">
        <div class="message-text message-text-warn">
            You have reached to the limit for Free account. If you want to add more Upgrade to Premium !
        </div>
        <div class="message-image">
            <img src="<?php echo BASEURL ?>assets/clips/issue.png" alt="error image">
        </div>
        <div class="message-btn">
            <a class="message-warn" href="<?php echo BASEURL . "joinRequests/getRequests/".$_SESSION['cid'] ?>">OK</a>
        </div>
    </div>
</div>
